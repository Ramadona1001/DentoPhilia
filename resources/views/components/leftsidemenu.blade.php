<nav id="navigation-widget" class="navigation-widget navigation-widget-desktop sidebar left hidden" data-simplebar="">
    ...
    <figure class="navigation-widget-cover liquid">
      <img src="{{ asset('dento/img/cover/01.jpg') }}" alt="cover-01">
    </figure>
    <!-- /NAVIGATION WIDGET COVER -->
    ...
    <div class="user-short-description">
      ...
      <a class="user-short-description-avatar user-avatar medium" href="profile-timeline.html">
        ...
        <div class="user-avatar-content">
          <!-- HEXAGON -->
          <div class="hexagon-image-82-90" data-src="{{ asset('dento/img/avatar/01.jpg') }}"></div>
          <!-- /HEXAGON -->
        </div>
        <!-- /USER AVATAR CONTENT -->
    ...
    <div class="badge-list small">
      ...
      <div class="badge-item">
        <img src="{{ asset('dento/img/badge/gold-s.png') }}" alt="badge-gold-s">
      </div>
      <!-- /BADGE ITEM -->

      <!-- BADGE ITEM -->
      <div class="badge-item">
        <img src="{{ asset('dento/img/badge/age-s.png') }}" alt="badge-age-s">
      </div>
      <!-- /BADGE ITEM -->

      <!-- BADGE ITEM -->
      <div class="badge-item">
        <img src="{{ asset('dento/img/badge/caffeinated-s.png') }}" alt="badge-caffeinated-s">
      </div>
      <!-- /BADGE ITEM -->

      <!-- BADGE ITEM -->
      <div class="badge-item">
        <img src="{{ asset('dento/img/badge/warrior-s.png') }}" alt="badge-warrior-s">
      </div>
      <!-- /BADGE ITEM -->

      <!-- BADGE ITEM -->
      <a class="badge-item" href="profile-badges.html">
        <img src="{{ asset('dento/img/badge/blank-s.png') }}" alt="badge-blank-s">
        <!-- BADGE ITEM TEXT -->
