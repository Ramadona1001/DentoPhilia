            ...
            <div class="user-status notification">
              ...
              <div class="user-status-avatar">
                ...
                <div class="user-avatar small no-outline">
                  ...
                  <div class="user-avatar-content">
                    <!-- HEXAGON -->
                    <div class="hexagon-image-30-32" data-src="{{ asset('dento/img/avatar/15.jpg') }}"></div>
                    <!-- /HEXAGON -->
                  </div>
                  <!-- /USER AVATAR CONTENT -->
            ...
            <div class="user-status notification">
              ...
              <div class="user-status-avatar">
                ...
                <div class="user-avatar small no-border">
                  ...
                  <div class="user-avatar-content">
                    <!-- HEXAGON -->
                    <div class="hexagon-image-40-44" data-src="{{ asset('dento/img/avatar/24.jpg') }}"></div>
                    <!-- /HEXAGON -->
                  </div>
                  <!-- /USER AVATAR CONTENT -->
                </div>
            ...
            <div class="user-status no-padding-top">
              ...
              <div class="user-status-avatar">
                ...
                <figure class="picture small round liquid">
                  <img src="{{ asset('dento/img/marketplace/items/07.jpg') }}" alt="item-07">
                </figure>
                <!-- /PICTURE -->
              </div>
              <!-- /USER STATUS AVATAR -->
