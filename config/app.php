...
return [
    ...
    */
    ...
    'providers' => [
        ...
        Menus\Providers\MenuServiceProvider::class,
        MainSettings\Providers\MainSettingServiceProvider::class,
        Blogs\Providers\BlogServiceProvider::class,
        Categories\Providers\CategoryServiceProvider::class,
        Services\Providers\ServiceServiceProvider::class,
        Home\Providers\HomeServiceProvider::class,
        Translates\Providers\TranslateServiceProvider::class,
        Contacts\Providers\ContactServiceProvider::class,
