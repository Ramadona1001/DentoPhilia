    ...
    <div class="centered-on-mobile">
        ...
        <div class="widget-box">
            ...
            <div class="widget-box-content">
              <form  method="POST" action="{{ route('complete_profile_post_doctors',Crypt::encrypt($doctor->id)) }}">
                @csrf
                ...
                <div class="form-row split">
                    <div class="form-item">
                        ...
                        <input type="text" id="profile-name" value="{{ $doctor->user->name }}" name="name" required>
                        </div>
                    </div>
                ...
                <div class="form-row split">
                    ...
                    <div class="form-item">
                        ...
                        <input type="password" id="profile-confirm-password" name="password_confirmation">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row split">
                    ...
                    <div class="form-item">
                        <div class="form-input small active">
                        <label for="profile-mobile">{{ transWord('University') }}</label>
                ...
                <div class="form-row split">
                    ...
                    <div class="form-item">
                        <div class="form-input small active">
                        <label for="profile-faculty">{{ transWord('Faculty') }}</label>
                        <input type="text" id="profile-faculty" value="{{ $doctor->faculty }}" class="other-input" name="faculty" required>
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" id="profile-address" class="other-input" value="{{ $doctor->address }}" name="address" required>
                        </div>
                    </div>
                ...
                <div class="form-row split">
                    ...
                    <div class="form-item">
                        ...
                        <input type="date" id="profile-start" value="{{ $doctor->start_study }}" class="other-input" name="start_date" required>
                        </div>
                    </div>
