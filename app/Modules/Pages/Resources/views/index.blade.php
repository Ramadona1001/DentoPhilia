                ...
                <ul class="header-dropdown dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('create_pages') }}"><i class="icon-book-open"></i> {{ transWord('Add New Pages') }}</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                                ...
                                <td style="background: #595f66;color:white;">
                                    <li class="dropdown language-menu" style="list-style: none">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item pt-2 pb-2" href="{{ route('show_pages',Crypt::encrypt($p->id)) }}"><i class="fa fa-eye"></i> {{ transWord('Show') }}</a>
                                            <a class="dropdown-item pt-2 pb-2" href="{{ route('edit_pages',Crypt::encrypt($p->id)) }}"><i class="fa fa-edit"></i> {{ transWord('Edit') }}</a>
                                            <a class="dropdown-item pt-2 pb-2" id="deleteBtn" href="{{ route('destroy_pages',Crypt::encrypt($p->id)) }}" onclick="return confirm('{{ transWord('Are You Sure?') }}')"><i class="fa fa-trash"></i> {{ transWord('Delete') }}</a>
                                        </div>
                                    </li>
                                </td>
                            </tr>
