      ...
      <div class="user-short-description big">
        ...
        <a class="user-short-description-avatar user-avatar big" href="profile-timeline.html">
          ...
          <div class="user-avatar-content">
            <!-- HEXAGON -->
          @if ($business_account->user->gender == 'Male')
          <div class="hexagon-image-100-110" data-src="{{ asset('dento/img/avatar/businessman.png') }}" style="width: 100px; height: 110px; position: relative;"><canvas width="100" height="110" style="position: absolute; top: 0px; left: 0px;"></canvas></div>
          @else
          <div class="hexagon-image-100-110" data-src="{{ asset('dento/img/avatar/businesswoman.png') }}" style="width: 100px; height: 110px; position: relative;"><canvas width="100" height="110" style="position: absolute; top: 0px; left: 0px;"></canvas></div>
          @endif
            <!-- /HEXAGON -->
          </div>
          <!-- /USER AVATAR CONTENT -->
        ...
        <p class="user-short-description-title"><a href="profile-timeline.html">{{ $business_account->user->name }}</a></p>
        <!-- /USER SHORT DESCRIPTION TITLE -->

        <!-- USER SHORT DESCRIPTION TEXT -->
        <p class="user-short-description-text"><a href="#">{{ '@'.$business_account->user->username }}</a></p>
        <!-- /USER SHORT DESCRIPTION TEXT -->
      </div>
      <!-- /USER SHORT DESCRIPTION -->
