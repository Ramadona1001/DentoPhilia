      ...
      <div class="grid-column">
        ...
        <div class="widget-box">
          ...
          <div class="widget-box-content">
            <p class="paragraph" style="text-align:center;font-weight:bold;">{{ $business_account->user->name }}</p>

            <div class="information-line-list">
              <div class="information-line">
                <p class="information-line-title">{{ transWord('Joined') }}</p>
                <p class="information-line-text">{{ $business_account->user->created_at->diffForHumans() }}</p>
              </div>


              <div class="information-line">
                <p class="information-line-title">{{ transWord('Mobile') }}</p>
                <p class="information-line-text">{{ $business_account->mobile }}</p>
              </div>

              <div class="information-line">
                <p class="information-line-title">{{ transWord('Commercial Record') }}</p>
                <p class="information-line-text">
                    <a href="{{ asset('uploads/business_accounts/commercial_records/'.$business_account->commercial_record) }}">
                        {{ transWord('View') }}
                    </a>
                </p>
              </div>
              ...
              <div class="information-line">
                <p class="information-line-title">{{ transWord('Tax Card') }}</p>
                <p class="information-line-text">
                    <a href="{{ asset('uploads/business_accounts/tax_cards/'.$business_account->tax_card) }}">
                        {{ transWord('View') }}
                    </a>
                </p>
              </div>
              ...
              <div class="information-line">
                ...
                <p class="information-line-text">{{ $business_account->user->gender }}</p>
              </div>

              <div class="information-line">
                <p class="information-line-title">{{ transWord('Email') }}</p>
                <p class="information-line-text"><a href="mailto:{{ $business_account->user->email }}">{{ $business_account->user->email }}</a></p>
              </div>
            ...
            <div class="widget-box-content">
              ...
              <div class="information-line-list">
                ...
                <div class="information-line">
                    ...
                    <p class="information-line-text">{{ $business_account->faculty }}</p>
                  </div>

                  <div class="information-line">
                      <p class="information-line-title">{{ transWord('Study Start') }}</p>
                      <p class="information-line-text">{{ $business_account->start_study }}</p>
                  </div>

                  <div class="information-line">
                      <p class="information-line-title">{{ transWord('Study End') }}</p>
                      @if ($business_account->end_study == null)
                      <p class="information-line-text">{{ transWord('Till Now') }}</p>
                      @else
                      <p class="information-line-text">{{ $business_account->end_study }}</p>
                      @endif
                  </div>
