    ...
    <div class="centered-on-mobile">
        ...
        <div class="widget-box">
            ...
            <div class="widget-box-content">
              <form  method="GET" action="{{ route('update_users',Crypt::encrypt($user->id)) }}">
                @csrf
                ...
                <div class="form-row split">
                    <div class="form-item">
                        ...
                        <input type="text" id="profile-name" value="{{ $user->name }}" name="name" required>
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <p class="not-allow-input">{{ $user->email }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row split">
                    <div class="form-item">
                        ...
                        <p class="not-allow-input">{{ '@'.$user->username }}</p>
                        </div>
                    </div>
