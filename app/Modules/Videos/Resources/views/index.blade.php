      ...
      <div class="section-filters-bar v7">
        <div class="section-filters-bar-actions">
          <div class="section-filters-bar-info">
            ...
            @endphp
            <p class="section-filters-bar-title"><a href="#" style="font-size: 14px;">{{ $item->name.' '.transWord('For').' '.$itemFor }}</a></p>
            <p class="section-filters-bar-text">
              <a href="{{ route('create_second_item_categories',Crypt::encrypt($item->id)) }}" class="button secondary">{{ transWord('Add Sub Category') }}</a>
            </p>
          </div>
        </div>
      </div>
