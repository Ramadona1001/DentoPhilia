              ...
              <form  method="POST" action="{{ route('store_videos') }}" enctype="multipart/form-data">
                ...
                <div class="form-row split">
                    <div class="form-item">
                        ...
                        <input type="text" id="profile-name" name="title" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row split">
                    <div class="form-item">
                        ...
                        <textarea name="content" id="profile-desc" cols="30" rows="10" required></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row split">
                    <div class="form-item">
                        <video width="400" controls style="width: 100%; border-radius: 16px; height: 250px;">
                ...
                <div class="form-row split">
                    ...
                    <div class="form-item">
                        ...
                        <input type="file" id="profile-image"  class="other-input file_multi_video" name="video" accept="video/*">
                        </div>
                    </div>
