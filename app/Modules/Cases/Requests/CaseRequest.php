...
class CaseRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'preoperative_image' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048',
            'processingoperative_title' => 'required',
            'processingoperative_image' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048',
            'postoperative_title' => 'required',
            'postoperative_image' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'preoperative_image.required' => transWord('Pre Operative Image').' '.transWord('is required'),
            'processingoperative_image.required' => transWord('Processing Operative Image').' '.transWord('is required'),
            'postoperative_image.required' => transWord('Post Operative Image').' '.transWord('is required'),
